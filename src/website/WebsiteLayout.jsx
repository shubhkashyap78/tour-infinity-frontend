  ...
  return (
    <nav className="ws-nav">
      <Link to="/" className="ws-nav-brand">
        <img src="/assests/logo.png" alt="Andaman Destinations" className="ws-nav-logo" />
        <span>Andaman Destinations</span>
      </Link>
    ...
    <CartProvider>
      <div className="ws-layout">
        ...
        <footer className="ws-footer">
          © {new Date().getFullYear()} Andaman Destinations. All rights reserved.
