    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "3px solid #1d1a15", paddingBottom: 20, marginBottom: 24 }}>
        <div>
          ...
          />
          <div style={{ fontSize: 22, fontWeight: 800, letterSpacing: 1 }}>Andaman Destinations</div>
          ...
          <div style={{ marginTop: 10, fontSize: 12, color: "#6b5b4a", lineHeight: 1.8 }}>
            ...
            <div>✉️ info@andamandestinations.com</div>
          </div>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 24 }}>
        <div>
          ...
          <div style={{ fontSize: 15, fontWeight: 700 }}>Andaman Destinations</div>
          <div style={{ fontSize: 12, color: "#6b5b4a", lineHeight: 1.8 }}>
            <div>Andaman, Indian Ocean</div>
            <div>9476044578 / 7063961694</div>
            <div>info@andamandestinations.com</div>
          </div>
        </div>
        <div>
      ...
      <div style={{ borderTop: "1px solid #e2cbb3", paddingTop: 16, textAlign: "center", fontSize: 12, color: "#9b8b7a" }}>
        Thank you for choosing Andaman Destinations — Andaman Travel &amp; Tours
      </div>
    </div>
  );
}
...
export default function InvoicePage({ bookingId, token, onClose }) {
  ...
  const handleWhatsApp = () => {
    ...
    const msg = [
      ...
      ``,
      `Thank you for choosing Andaman Destinations 🌴`,
